...
//      {
//      case OCTO_FULL:
//         OctoFull.executeOctoFullActivity(action.entity, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case OCTO_NOT_FULL:
//         OctoNotFull.executeOctoNotFullActivity(action.entity, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case FISH:
//         Fish.executeFishActivity(action.entity, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      case CRAB:
//         Crab.executeCrabActivity(action.entity, action.world,
//            action.imageStore, scheduler);
//         break;
//
//      case QUAKE:
//         Quake.executeQuakeActivity(action.entity, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      case SGRASS:
//         SGrass.executeSgrassActivity(action.entity, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      case ATLANTIS:
//         Atlantis.executeAtlantisActivity(action.entity, action.world, action.imageStore,
//            scheduler);
//         break;
//
//      default:
...
//            entity.actionPeriod);
//         scheduleEvent(scheduler, entity,
//            createAnimationAction(entity, 0), Entity.getAnimationPeriod(entity));
//         break;
//
//      case FISH:
//         scheduleEvent(scheduler, entity,
...
//         try
//         {
//            if (!WorldModel.processLine(in.nextLine(), world, imageStore))
//            {
...
//              WorldModel.getOccupancyCell(world, pos) != null;
//   }
...
//         WorldModel.removeEntityAt(world, pos);
